...
OAuth2Strategy.prototype.authenticate = function(req, options) {
  ...
  /*
   * If there is an error, fail and show the error.
   */
  ...
  /*
   * Parse the callback URL, which is relative.
   * Therefore the URL is resolved into a fully-qualified URL.
   */
  ...
  /*
   * Collect the meta data about the passport.
   */
  var meta = {
   ...
   * If there is, start the process to get the access token.
   */
