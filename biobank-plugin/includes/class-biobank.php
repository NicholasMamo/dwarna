...
class Biobank {
	...
	private function define_public_hooks() {
		...
		$this->loader->add_action( 'wp_logout', $plugin_public, 'clear_access_token' );
		...
		$this->loader->add_action('after_password_reset', $plugin_public, 'after_password_reset');

		$this->loader->add_action('login_head', $plugin_public, 'change_login_logo');
