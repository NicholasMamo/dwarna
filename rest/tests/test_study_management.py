...
class StudyManagementTest(BiobankTestCase):
	...
	@BiobankTestCase.isolated_test
	def test_update_study_with_recruiting_false(self):
		"""
		Test that when updating a study the recruitment flag with False, it is saved.
		"""
	...
	@BiobankTestCase.isolated_test
	def test_update_study_with_recruiting_true(self):
		"""
		Test that when updating a study the recruitment flag with True, it is saved.
		"""
