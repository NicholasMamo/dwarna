...
class UserManagementTest(BiobankTestCase):
	...
	def test_create_participant(self):
		"""
		Test creating a partic normally.
		"""
	...
	def test_only_participants_returned(self):
		"""
		Test that researchers and participants are not returned with participants.
		"""
	...
	def test_participant_removal_sanitation(self):
		"""
		Test that the participant removal sanitizes the input.
		"""
