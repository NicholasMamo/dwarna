...
class StudyHandler(PostgreSQLRouteHandler):
	...
	def create_study(self, study_id, name, description, homepage, attachment=None, recruiting=True, researchers=None, *args, **kwargs):
		"""
		...
		try:
			...
			self._connector.execute([
				...
				VALUES ('%s', '%s', '%s', '%s', '%s', '%r');""" % (study_id, name, description, homepage, attachment or '', recruiting),
			])
	...
	def update_study(self, study_id, name, description, homepage, recruiting, attachment=None, researchers=None, *args, **kwargs):
		"""
		...
		try:
			...
			self._connector.execute([
				...
				SET
					...
					"recruiting" = '%r'
				WHERE
					"study_id" = '%s';""" % (name, description, homepage, recruiting, study_id),
			])
